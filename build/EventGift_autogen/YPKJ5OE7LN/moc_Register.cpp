...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Register::*)()>(_a, &Register::goBack, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Register::*)(const QString & , const QString & )>(_a, &Register::applyClicked, 1))
            return;
    }
}
...
// SIGNAL 0
void Register::goBack()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Register::applyClicked(const QString & _t1, const QString & _t2)
{
